---
title: "Daily Exercise 18 & 19: In Class Demo and Model Tuning Basics"
...
da18_deliverable <- ggplot(predictions, aes(x = logC, y = .pred)) + 
  geom_point() + 
  geom_abline() +
...
ggsave("images/da18_plot.png", plot = da18_deliverable, width = 8, height = 6, dpi = 300)
